...
const EmployeePhoto = () => {
  ...
  return (
    <div className="employee-photo">
      <img src={employee.photoCompany} alt="Employee" />
...
const EmployeeInfo = () => {
  ...
  return (
    <div className="employee-info">
      ...
      <p>ID no: {employee.idno}</p>
      <p>Joined Date: {employee.joinedDate}</p>
      <p>Expire Date: {employee.expiredate}</p>
      <p>D.O.B : {employee.dob}</p>
      <p>Phone: {employee.phone}</p>
      
      {/* Aquí puedes agregar más información del empleado si lo deseas */}
    </div>
  );
};
